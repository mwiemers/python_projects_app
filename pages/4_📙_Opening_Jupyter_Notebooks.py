...
<br>
 ...
 <div class="highlight blue">
    Come to the Python workshops if you struggle with any of the steps from this tutorial. You can find more information about the workshops in the 
...
Go to the Python workshops section to learn about the format of the Python workshops and how to sign up for a session.
"""
)
